...
CSV_OUT = os.path.join(ROOT, "experiments", "tie_alpha_curve_rps1.csv")
...
ALPHAS = [0.0, 1.0, 2.0, 5.0, 10.0, 20.0, 30.0, 40.0, 50.0, 60.0, 80.0, 100.0, 150.0, 200.0]
...
def main() -> None:
    ...
    out_path = os.path.join(FIGURES_DIR, "fig_tie_alpha_curve_rps1.png")
